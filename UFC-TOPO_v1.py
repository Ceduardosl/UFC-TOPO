...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lat_inf_label.setGeometry(QtCore.QRect(320, 150, 101, 16))
        ...
        self.lat_inf_line.setGeometry(QtCore.QRect(220, 150, 90, 20))
        ...
        self.lat_sup_line.setGeometry(QtCore.QRect(10, 150, 90, 20))
        ...
        self.lat_sup_label.setGeometry(QtCore.QRect(110, 150, 101, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "UFC-TOPO"))
        ...
        self.proj_label.setText(_translate("MainWindow", "Projeção (Formato EPSG) // Ex: 31984 = SIRGAS 2000 UTM 24S"))
        ...
        self.dir_raster_button.setText(_translate("MainWindow", "Buscar"))
        self.dir_raster_label.setText(_translate("MainWindow", "Diretório de saída dos Rasters:"))
...
def merge_raster(dir_raster, dir_output_merge):
    ...
    mosaic_raster = []
    for path_raster in raster_list: #mudar o nome dessa variável, dir_raster ou path_raster
